...
MODEL_PATH = "ml_pipeline/models/points_model_with_oof_minutes.pkl"
FEATURES_PATH = "ml_pipeline/data/features_player_points_with_oof_minutes.csv"
OUTPUT_PATH = "ml_pipeline/models/points_model_calibration_with_oof_minutes.pkl"
DROP_COLUMNS = [
    "PLAYER_ID",
    "PLAYER_NAME",
    "GAME_DATE",
