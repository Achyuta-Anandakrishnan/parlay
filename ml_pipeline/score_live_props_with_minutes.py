...
POINTS_MODEL_PATH = "ml_pipeline/models/points_model_with_minutes.pkl"
CALIBRATION_PATH = "ml_pipeline/models/points_model_calibration_with_minutes.pkl"
...
OUTPUT_PATH = "ml_pipeline/data/live_scored_props_with_minutes.csv"
PLAYER_ALIASES = {
...
def main():
    ...
    reconstructed_df["predicted_minutes"] = minutes_model.predict(X_minutes)
    reconstructed_df["predicted_minus_recent_minutes"] = (
        reconstructed_df["predicted_minutes"] - reconstructed_df["min_last_5"]
    )
